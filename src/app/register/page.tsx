...
export default function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="relative flex flex-col mx-3 sm:m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row-reverse md:space-y-0">
        <div className="flex flex-col justify-center p-8 md:py-14">
        ...
        <div className="relative mx-4">
          ...
          />
          <div className="absolute hidden bottom-10 left-6 p-6 bg-black bg-opacity-30 backdrop-blur-sm rounded drop-shadow-lg md:block">
